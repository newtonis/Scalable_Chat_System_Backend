...
AI was used as a guide with debugging (mostly Gemini) and to generate initial code snippets with Claude. However the implementation of all architecture was made by hand using these snipets as a starting point. No part of the code is made entirely by AI with no review.
